...
pg = st.navigation({
    ...
    "Aircraft Systems": [ac_general_page, indicating_recording_page, electrical_page, communications_page, lighting_page, fire_protection_page, flight_controls_page, fuel_page, powerplant_page],
