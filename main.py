...
pg = st.navigation({
    ...
    "Nice to Know": [altitudes_page, temperatures_page],
    "Aircraft Systems": [ac_general_page, ace_page, indicating_recording_page, electrical_page, communications_page, environmental_control_page, ice_protection_page, landing_gear_page ,lighting_page, fire_protection_page, flight_controls_page, fuel_page, oxygen_control_page, powerplant_page],
