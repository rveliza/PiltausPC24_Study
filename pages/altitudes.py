...
altitude_params = {"FL450": "8,000 ft Cabin @8.83 psi.  9.07 psi OFV starts to open.  9.27 Max", 
                   ...
                   "24,800": "FIELD HI trigger point", 
                   "15,000": "EDM descent altitude, Ram Air Max for opening", 
                   "14,800": """:red-background[CAB ALT] Backup warning based on analog sensor reading - Backup Avionics oxygen Deploy Set-Point""", 
                   ...
                   "9,500": ":red-background[CAB ALT] Normal operation - EDM triggered after 5 seconds",
                   "8,300": "Field HI", "0": "Select an altitude"}

altitude = st.radio("Select an altitude", ["FL450", "FL300", "24,800", "15,000", "14,800", "14,500", "14,200", "12,850", "9,500", "8,300", "0"], index=10, label_visibility="collapsed")
